...
1. `bash tests/governance/test_phase3_slo_runbook_presence.sh`
2. `bash tests/governance/test_phase3_security_ops_presence.sh`
3. `bash tests/governance/test_phase3_cost_guardrails_presence.sh`
4. `bash tests/governance/test_phase3_release_automation_presence.sh`
5. `bash scripts/ci/final_gate.sh`
6. `bash tests/governance/test_docs_presence.sh`
7. `bash tests/governance/test_e2e_governance.sh`
