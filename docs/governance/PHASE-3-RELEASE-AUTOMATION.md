...
2. `DRY_RUN=1 bash scripts/ci/release_go_live.sh`
3. `bash tests/governance/test_phase3_slo_runbook_presence.sh`
4. `bash tests/governance/test_phase3_security_ops_presence.sh`
5. `bash tests/governance/test_phase3_cost_guardrails_presence.sh`
6. `bash tests/governance/test_phase3_release_automation_presence.sh`
7. `bash scripts/ci/final_gate.sh`
8. `bash tests/governance/test_docs_presence.sh`
9. `bash tests/governance/test_e2e_governance.sh`
